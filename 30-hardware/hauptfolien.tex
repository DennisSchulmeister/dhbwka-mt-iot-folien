%%%% Geplante Struktur:
%%%%
%%%%  * Anschlüsse am Pi, elektrische Eigenschaften, ...
%%%%  * Binäre Ein-/Ausgänge: Buttons, LEDs, ...
%%%%      --> Matrixschaltung, Shift-Register ?
%%%%  * Serielle Kommunikation
%%%%      --> DHT11, I2S, Arduino/Atmega, ...
%%%%  * Pulsweitenmodulation
%%%%      --> Mit dem PI, Mit separatem PCMxxxx-Baustein
%%%%  * Analogsignale
%%%%      --> Serieller A/D-Wandler, R2R-Leiter, PWM+Filter?
...
\begin{frame}[allowframebreaks]{Was ist elektrischer Strom?}
    \begin{columns}
        ...
        \column{.6\textwidth}
        \raisebox{-0.5\height}{\includegraphics[width=.6\textwidth]{img/atom_detail}}

        \column{.4\textwidth}
        \raisebox{-0.25\height}{\includegraphics[width=.4cm]{img/atom_kern}}
        \hskip 1em
        Atomkern \\
        \smallskip

        \raisebox{-0.25\height}{\includegraphics[width=.4cm]{img/atom_schale}}
        \hskip 1em
        Schale \\
        \bigskip

        \raisebox{-0.25\height}{\includegraphics[width=.4cm]{img/atom_elektron}}
        \hskip 1em
        Elektron \\
        \smallskip

        \raisebox{-0.25\height}{\includegraphics[width=.4cm]{img/atom_proton}}
        \hskip 1em
        Proton \\
        \smallskip

        \raisebox{-0.25\height}{\includegraphics[width=.4cm]{img/atom_neutron}}
        \hskip 1em
        Neutron \\
    \end{columns}
    ...
    \parbox{\linewidth}{
        ...
        geradlinig durch das Material hindurch wandert. Viel mehr nimmt es einen
...
\begin{frame}{Berechnung der Leistung}
    \begin{columns}
        \column{.4\textwidth}
        \begin{center}
            \includegraphics[width=.4\textwidth]{img/formel_pui}
        \end{center}
    ...
    \Justified{
        ...
        \textbf{ohmschen Widerstand von einem Ohm eine Spannung von einem Volt} (und damit
        eine Stromstärke von einem Ampere) \textbf{während einer Sekunde} zu erhalten. Daraus
...
\begin{frame}[fragile, allowframebreaks]{Binärsignal ausgeben am Beispiel einer LED}
    \Justified{
...
\begin{frame}[fragile, allowframebreaks]{Gemittelte Leistung durch Pulsweitenmodulation regulieren}
    \parbox{\linewidth}{
...
\begin{frame}[fragile, allowframebreaks]{Digitaleingang mit Active-High-Logik (z.B. Taster)}
    \Justified{
...
\begin{frame}[fragile, allowframebreaks]{Digitaleingang mit Active-Low-Logik (z.B. Lichtschranke)}
    \Justified{
